	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">商家号</label> 
							<input type="text" name="shangjiahao" placeholder="商家号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="shangjiamingcheng" placeholder="商家名称" class="form-control-i">
							</div>
																																			<div class="form-group">
