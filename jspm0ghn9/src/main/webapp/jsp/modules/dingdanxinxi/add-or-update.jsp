...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>下单日期</label>
										<div id="xiadanriqiDate" class="input-append date form_datetime">
											<input id="xiadanriqi-input" name="xiadanriqi" size="15" type="text" readonly>
	...
	<script>
		...
		function dataBind(){
			...
			$("#xiadanriqi-input").val(ruleForm.xiadanriqi);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.xiadanriqi != null && res.data.xiadanriqi != ''){

					$("#xiadanriqi-input").val(res.data.xiadanriqi);
					$('#xiadanriqiFileName').val(res.data.xiadanriqi)
					}
