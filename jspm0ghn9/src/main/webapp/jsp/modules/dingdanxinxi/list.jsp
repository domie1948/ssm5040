...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('xiadanriqi')">下单日期<i id="xiadanriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var xiadanriqiCell  = document.createElement('td');

						  xiadanriqiCell.innerHTML = item.xiadanriqi;


			row.appendChild(xiadanriqiCell);
            ...
            crossBtn1.innerHTML = "发货"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"dingdanpeisong\")");
			if(crossBtnControl('发货') == true){
